...
//>>built
define(["require","exports","./Util","dojox/xml/parser"],function(m,n,e,l){return function(){function c(a){var f=e.VertexAttrConstants,d;for(d in f)this[f[d]]=e.VertexAttrConstants[d];if(a)for(var b in a)this[b]=a[b]}c.prototype._parse=function(a){a=l.parse(a).getElementsByTagName("snippet");for(var f=/\$[a-zA-Z0-9]+[ \t]*/,d=/[\$\s]+/g,b=0;b<a.length;b++){var c=a[b].getAttribute("name");e.assert(null==this[c]);for(var g=a[b].textContent;;){var h=g.match(f);if(null==h)break;var k=this[h[0].replace(d,
